...
@StructClass
public class PackageVtoCPostEkCV {
    @StructField(order = 0)
    ...
    public PackageVtoCPostEkCV(String ReceiverID1,String SenderID1,String TS1,int SubjectLen1,int TextLen1,String AttachmentName1,int AttachmentLen1,byte[] Content1,byte[] EscMd51){
